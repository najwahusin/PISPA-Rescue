...
/* ── Socket.io — Railway-compatible configuration ─────────────────
   Railway proxies traffic through its load balancer. Without these
   settings Socket.io connections fail with CORS / transport errors.
   ─────────────────────────────────────────────────────────────── */
const io = new Server(server, {
  ...
  pingInterval: 25000,              // ping every 25s to keep Railway alive
});

/* Railway sits behind a proxy — makes req.ip and headers work correctly */
